...
try:
    modelo_general = joblib.load(
        "model/modelo_general_red_neuronal_mejorado.pkl"
    )
...
def predict(datos: SaludInput):
    ...
    try:
        ...
        # ====================================================
        # DATAFRAME EXACTAMENTE IGUAL AL ENTRENAMIENTO
        # ====================================================
        ...
        return {
            ...
            "resultado_modelo": {
                ...
                "clase": prediccion,
                "nivel_riesgo": niveles[prediccion],
